...
namespace EasySave.Model
{
    internal class DifferentialBackupStrategy : IBackupStrategy
    {
        ...
        public async Task Execute(string jobName, string sourceDir, string targetDir, StateTracker stateTracker, BusinessSoftwareService businessService = null, JobController controller = null)
        {
